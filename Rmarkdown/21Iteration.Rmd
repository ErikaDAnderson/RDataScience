...
-Works (but selects only the first named duplicate element without error), but if you use the name to pull the value out there is an error: Error in nm[[x]] : attempt to select more than one element in vectorIndex
