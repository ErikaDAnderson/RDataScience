...
Overnight is a binary variable, so if the arrival time is before the depareture time, it equals one. If it does not, it equals zero. Arrival time then is adjusted by one day, only if the flight is overnight. Otherwise the zero variable drops out of the adjustment.
