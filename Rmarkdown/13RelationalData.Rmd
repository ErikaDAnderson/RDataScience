...
So the columns from flights are returned (that have matches in airports) in the first anti-join and the columns from airports (that have matches in flights) are returned in the second anti-join.
...
Yes planes with the same tail number were flown by different carriers in this data set.
