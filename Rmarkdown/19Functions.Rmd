...
if (x == 3) {message("x is correct")} # only has response if correct

ifelse(x == 2, 2, 3) # output has to match the input

if (x == 2) {message("x is two")} else {message("x is not two")} # gives two possible answers
