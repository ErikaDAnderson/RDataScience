...
# ?summarise_each is deprecated too in favour of mutate_all
# try using it to produce similar dataframe
# not quite there, as it has one row per observation with lists of values for each
mtcars %>%
  group_by(cyl) %>%
  mutate_all(., list)
...
Lists are difference because they can contain more than one type of value and difference amounts.
