...
- correct mispelled function name filter
...
```
- the dataset is not called diamond
...
# 5 Data Transformation Exercises
 ...
 See section [5 Data Tranformation](https://r4ds.had.co.nz/transform.html) for text and exercises. I found some answers [online](https://jrnold.github.io/r4ds-exercise-solutions/workflow-basics.html).
