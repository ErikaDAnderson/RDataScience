...
The remove = TRUE options means the original column will remain in the resulting data frame. You can set it to FALSE to remove the original field.
...
# select top five countries to display
who_top9 <- who_sum %>%
  group_by(country) %>%
...
# take top five from summed data
who_top <- who_sum %>%
